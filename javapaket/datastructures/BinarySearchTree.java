...
/**
 * A simple binary searchtree ordered by the method compareTo for the elements.
 * 
 * @author (Bror Bjerner)
 * @version (2007)
 */
...
public class BinarySearchTree<E extends Comparable<? super E>> extends
	 ...
	 * @returns true if the element is contained in the tree, otherwise false is
	 *          returned.
	 */
	...
	/**
	 * Remove the first occurance of an element for which compareTo with the
	 * argument yields 0. If no element is removed false is returned, otherwise
	 * true.
	 * 
	 * @param elem
	 *            element of Comarable
