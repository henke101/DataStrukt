...
public class Uppg2 {
	 ...
	 * parameter.
	 * Will always consider the accuracy to be the interval between
	 * the parameter and 0 (1 is the same as -1; the absolute value).
	 * 
	 * @param sqr The number it finds the root of, must be greater than
	 * or equal to 1
	 * @param eps Defines the accuracy of the result
	...
	private static double help(double sqr, double eps, 
