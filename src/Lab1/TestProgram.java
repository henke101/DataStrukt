...
public class TestProgram {
	...
	public static void main(String[] args) {
		...
		System.out.println("*" + (test.empty())
				+ " # det ska stå true då den är tom");
		...
		System.out.println("*" + (test.setPToIndexOf("test"))
				+ " # ska vara true");
		System.out.println("*" + (test.setPToIndexOf("326"))
				+ " # ska vara false");
		try {
			test.addFirst(null);
		} catch (IllegalArgumentException e) {
			System.out.println("*" + e
					+ " # det ska vara illegal argument med felmeddelande");
		}
		System.out.println("*" + test
				+ " # null skall inte finnas med i utskriften");
