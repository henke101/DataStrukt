...
public class MaxSumTest {
	...
	*/
	public static void main( String [ ] args ) {
		...
		for( int arraySize = 100/4; arraySize <= 1000000/4; arraySize *= 1.5 ) {
		...
		for( int alg = 1; alg <=3; alg++ ) {
			...
			for( int arraySize = 100/4; arraySize <= 1000000/4; arraySize *= 1.5 ) { // double the size every time
				// eventually skip this array size, too slow
				if( (alg == 1 && arraySize > 300) ||  (alg == 2 && arraySize > 1600)) {
